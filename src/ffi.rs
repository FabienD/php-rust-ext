...
#[repr(C)]
pub struct AspellSpeller;

#[repr(C)]
pub struct AspellCanHaveError;

// #[repr(C)]
// pub struct AspellWordList;

// #[repr(C)]
// pub struct AspellStringEnumeration;

extern "C" {
    pub fn new_aspell_config() -> *mut AspellConfig;
    pub fn aspell_config_replace(config: *mut AspellConfig, mode: *const c_char, lang: *const c_char);
    ...
    pub fn aspell_speller_check(speller: *mut AspellSpeller, word: *const c_char, size: c_int) -> c_int;
